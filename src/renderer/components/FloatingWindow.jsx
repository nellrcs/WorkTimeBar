...
export default function FloatingWindow() {
  ...
  const handleExit = () => window.electronAPI.send('exit', {});
            ...
            <div className="inline-flex items-center">
              <div className="flex flex-col border border-neutral-900 bg-neutral-900/20 rounded-xl overflow-hidden shadow-sm">
                ...
                <button
                  onClick={handleExit}
                  type="button"
                  className="inline-flex items-center justify-center p-2 text-neutral-500 hover:text-red-400 hover:bg-red-500/10 transition-colors duration-200"
                >
